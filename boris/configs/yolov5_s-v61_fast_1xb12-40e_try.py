...
_base_ = '/home/borisef/projects/mm/mmyolo/configs/yolov5/yolov5_s-v61_syncbn_fast_8xb16-300e_coco.py'

work_dir = "/home/borisef/projects/mm/mmyolo/boris/work_dirs/yolov5_s-v61_fast_1xb12-40e_try"

data_root = '/home/borisef/data/vehicles/' # dataset root
#class_name = ('cat', ) # dataset category name
CLASSES = ['Ambulance', 'Bus', 'Car', 'Motorcycle','Truck']
num_classes = len(CLASSES) # dataset category number
...
val_evaluator = dict(ann_file=data_root + 'test/annotations.json')
